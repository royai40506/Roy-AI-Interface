...
export default function RoyAvatarFX({
  ...
  return (
    ...
    >
      ...
      />
          {/* PHASE 4 - Talking mouth lipsync */}
          {state === "speaking" && (
            <motion.div
              className="absolute top-[59%] left-1/2 -translate-x-1/2 w-8 h-2 rounded-full bg-black/70 pointer-events-none"
              animate={{
                scaleY: [0.3, 1 + audioLevel * 2, 0.4, 1 + audioLevel, 0.3],
              }}
              transition={{
                duration: 0.15,
                repeat: Infinity,
